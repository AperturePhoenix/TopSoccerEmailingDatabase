                ...
                if (tempContact.isInCategory(tempCategory) || allContactsCheckBox.isSelected()) {
                    if (ageCheckBox.isSelected()) {
                        if (isWithinAgeRange(tempContact))
                            displayTemp.append(getInfo(tempContact)).append(" ").append(System.lineSeparator());
                    } else displayTemp.append(getInfo(tempContact)).append(" ").append(System.lineSeparator());
                    break;
                }
            }
        }
